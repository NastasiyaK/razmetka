...
enum pat_name {N_b, V_b, SV_b, VT, E, WPW, A_b, AFIBR, no_AFIBR, VFIBR, no_VFIBR, AFl, SVT, BLOCKII, V_T, V_B, SBR, no_VT,No, AS  };
...
//pat_name {N_b, V_b, SV_b, VT, E, WPW, A_b, AFIBR, no_AFIBR, VFIBR, no_VFIBR, AFl, SVTA, BLOCKII, V_T, V_B, SBR, no_VT,No, AS  };
